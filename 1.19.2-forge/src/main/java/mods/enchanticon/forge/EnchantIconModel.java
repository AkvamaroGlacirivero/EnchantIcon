...
public class EnchantIconModel implements IUnbakedGeometry<EnchantIconModel> {
    ...
    public BakedModel bake(IGeometryBakingContext context, ModelBakery bakery, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelState, ItemOverrides overrides, ResourceLocation modelLocation) {
        ...
        for (var entry : this.bgModels.entrySet()) {
            ...
            var baked = raw.bake(bakery, raw, spriteGetter, modelState, modelLocation, context.useBlockLight());
    ...
    @Override
    public Collection<Material> getMaterials(IGeometryBakingContext context, Function<ResourceLocation, UnbakedModel> modelGetter, Set<Pair<String, String>> textureErrors) {

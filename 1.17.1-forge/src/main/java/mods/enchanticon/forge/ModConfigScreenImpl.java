...
public class ModConfigScreenImpl {
    ...
    public static Screen create(Minecraft mc, Screen previous) {
        ...
        generalCategory.addEntry(builder.entryBuilder()
                ...
                .setDefaultValue(ModConfigImpl.backgroundTypeProp::get)
        ...
        generalCategory.addEntry(builder.entryBuilder()
                ...
                .setDefaultValue(ModConfigImpl.levelTypeProp::get)
        ...
        generalCategory.addEntry(builder.entryBuilder()
                ...
                .setDefaultValue(ModConfigImpl.applyingScopeInGuiProp::get)
        ...
        generalCategory.addEntry(builder.entryBuilder()
                ...
                .setDefaultValue(ModConfigImpl.applyingScopeInHandProp::get)

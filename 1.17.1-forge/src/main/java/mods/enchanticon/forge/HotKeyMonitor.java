...
public final class HotKeyMonitor {
    ...
    @SubscribeEvent
    public static void onKeyPressWithInGui(GuiScreenEvent.KeyboardKeyPressedEvent.Pre event) {
    ...
    @SubscribeEvent
    public static void onKeyReleaseWithInGui(GuiScreenEvent.KeyboardKeyReleasedEvent.Post event) {
        if (HotKeys.toggleEnchantIcon.isActiveAndMatches(InputConstants.getKey(event.getKeyCode(), event.getScanCode()))) {

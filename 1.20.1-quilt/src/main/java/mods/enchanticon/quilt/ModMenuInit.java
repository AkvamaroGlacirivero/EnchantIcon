...
public class ModMenuInit implements ModMenuApi {
    ...
    public static Screen create(Screen previous) {
        ...
        generalCategory.addEntry(builder.entryBuilder()
                ...
                .build());
        generalCategory.addEntry(builder.entryBuilder()
                .startEnumSelector(Component.translatable("enchant_icon.config.scope_for_gui_like"), ApplyingScope.class, ApplyingScope.ENCHANTED_BOOK_ONLY)
                ...
                .build());
        generalCategory.addEntry(builder.entryBuilder()
                .startEnumSelector(Component.translatable("enchant_icon.config.scope_for_hand_held"), ApplyingScope.class, ApplyingScope.ENCHANTED_BOOK_ONLY)
